...
Before running any model, prepare the data using the data preprocessing scripts in the folder `BalSAM/data_preparation`. 
The contents of this folder are based on a fork from the RSPrompter repository: [https://github.com/KyanChen/RSPrompter](https://github.com/KyanChen/RSPrompter).
Modified files from the original repo are marked at the beginning of the file. 
