...
We use Comet ML to log predictions. Set your `COMET_API_KEY` environment variable if you wish to log things into Comet.
...
```
python infer_with_nms.py ROOT_PATH_TO_TILES OUTPUT_PATH --points_per_side 10 --fold "test" --log_comet --comet_project_name COMET_PROJECT
``` 
