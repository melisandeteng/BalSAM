...
import sys
from transformers import Mask2FormerImageProcessor, Mask2FormerConfig, Mask2FormerModel
import json
import os
...
def main(seed=0):
    ...
    training_args = TrainingArguments(
        output_dir=f"/network/scratch/t/tengmeli/mask2former_fine_tuned_balsam/resize_dsm_neurips_{seed}",
        ...
        warmup_steps=500,
        weight_decay=0.01,
        logging_dir=f"/network/scratch/t/tengmeli/mask2former_fine_tuned_balsam/logs_resize_dsm_neurips_{seed}",
        logging_steps=100,
        save_steps=1000,
        save_total_limit=2,
