...
model_path =  "/network/scratch/t/tengmeli/mask2former_fine_tuned_balsam/baseswin_4021/checkpoint-196800/"

model = Mask2FormerForUniversalSegmentation.from_pretrained(model_path, config=config)
...
train_dataset = TreesDataset("test", 
        root_path=root_path,
        transform=None, 
        processor=processor
    )

train_dataloader = DataLoader(train_dataset, batch_size=1, shuffle=False, collate_fn=data_collator)
