...
def get_local_maxima_from_file(dsm_path, save_path):
    ...
    coordinates = peak_local_max(dsf, min_distance=50)
...
if __name__ == "__main__":
    ...
    with open(
        "/network/projects/trees-co2/final_tiles/merged_annots_dsm_test_new.json", "rb"
    ) as f:
        annots = json.load(f)
    save_path = "/network/projects/trees-co2/experiments/segmate_height_prompts_plantation"
