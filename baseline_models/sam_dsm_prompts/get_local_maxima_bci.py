...
if __name__ == "__main__":
    ...
    with open(
        "/network/projects/trees-co2/BCI/BCI_2022_tilessubset_family_full/merged_annots_dsm_test_new.json",
        "rb",
    ) as f:
        # ("/network/projects/trees-co2/final_tiles/merged_annots_dsm_test.json", "rb") as f:
        data = json.load(f)
    tiles = data["images"]
    save_path = "/network/projects/trees-co2/experiments/segmate_height_prompts_bci"
    for t in tiles:
        dsm_path = t["dsm_path"]
    ...
    # dsm_path = "/network/projects/trees-co2/dataset_dsm/2023_06_08_CB_Papinas_UTM19_Ortho/tiles"
    # get_local_maxima_foder(dsm_path, save_path)
