...
Dependencies for each part of the project are detailed in the `data_prep_sam_maskrcnn` and `rsprompter_balsam` folders. 
...
Code for these models with further instructions can be found in the folder `rsprompter_balsam`. 
